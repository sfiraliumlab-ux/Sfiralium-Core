Понял. Исправляю форматирование. Весь проект, структура и код теперь собраны в **одном единственном блоке**, чтобы ничего не разъезжалось. Вы можете просто скопировать всё содержимое ниже и сохранить как единый файл-инструкцию или разбить по папкам, следуя комментариям.
